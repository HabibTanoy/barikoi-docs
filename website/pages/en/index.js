...
class HomeSplash extends React.Component {
  render() {
    ...
    const Button = props => (
      <div className="pluginWrapper buttonWrapper" style={{padding:"5px"}}>
    ...
    return (
      <SplashContainer>
        ...
        <div className="inner">
          ...
          <h2 style={bkoi}>Barikoi Documentation</h2>
          <br></br>
          <br></br>
          <PromoSection >
            <Button href={docUrl('intro.html')}>Barikoi Api</Button>
            <Button href={docUrl('map-add')}>Maps API</Button>
